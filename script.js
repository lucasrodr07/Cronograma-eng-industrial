...
function renderizarGantt(startStr, endStr, tituloLabel) {
    ...
    // F11: LINHA FANTASMA
    // Blindada com pointer-events: none, e as colunas ganham as classes .col-proj e .col-area para manter o eixo
    h += `<tr class="no-print ghost-row">
            <td class="col-proj" style="height: 90px; border: none; background: transparent;"></td>
            <td class="col-area" style="border: none; background: transparent;"></td>
            <td colspan="${dArr.length}" style="border: none; background: transparent; pointer-events: none;"></td>
          </tr>`;
