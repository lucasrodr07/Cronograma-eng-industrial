...
const i18n = {
    'pt-br': {
        ...
        printTitle: "🖨️ Imprimir Cronograma", btnGen: "Gerar", printIncGantt: "Incluir Gráfico de Gantt visual",
    ...
    'en': {
        ...
        printTitle: "🖨️ Print Timeline", btnGen: "Generate", printIncGantt: "Include visual Gantt Chart",
    ...
    'de': {
        ...
        printTitle: "🖨️ Zeitplan drucken", btnGen: "Generieren", printIncGantt: "Visuelles Gantt-Diagramm einfügen",
    ...
    'es': {
        ...
        printTitle: "🖨️ Imprimir Cronograma", btnGen: "Generar", printIncGantt: "Incluir Gráfico de Gantt visual",
                ...
                data.camadas.forEach((camada, cIdx) => {
                    ...
                    while(dIdx < dArr.length) {
                        ...
                        if(task) {
                            ...
                            let iconeAlerta = ((task.progresso||0) < 100 && dayjs(task.fim).startOf('day').diff(dayjs().startOf('day'), 'day') <= 3) ? '⚠️ ' : '';
